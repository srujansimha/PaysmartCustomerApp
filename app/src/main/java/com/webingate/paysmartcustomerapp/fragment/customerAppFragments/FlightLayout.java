...
import com.webingate.paysmartcustomerapp.customerapp.PassengerDetails;
...
public class FlightLayout extends Fragment {
    ...
    public static FlightLayout newInstance(int SectionNumber) {
        FlightLayout home = new FlightLayout();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.flight_layout, container, false);
    ...
    private void goPage(int page) {
        ...
        switch(page){
            ...
            case ApplicationConstants.PASSENGERDETAILS:
                fragmentClass = FlightPassengerDetails.class;
                break;
        }
