package com.webingate.paysmartcustomerapp.repository.news;

import com.google.gson.Gson;
import com.google.gson.reflect.TypeToken;
import com.webingate.paysmartcustomerapp.object.News;
...
public class NewsRepository {
    ...
    public static News getNews() {
        ...
        ArrayList<News> newsArrayList = new Gson().fromJson(json, new  TypeToken<ArrayList<News>>(){}.getType());
        return newsArrayList.get(0);

    }

    public static ArrayList<News> getNewsList() {
        return new Gson().fromJson(json, new  TypeToken<ArrayList<News>>(){}.getType());
    }
