...
import com.webingate.paysmartcustomerapp.object.Course;
...
public class CourseListRepository {
    ...
    public static List<Course> getCourseList() {
        List<Course> courseList = new Gson().fromJson(courseJson, new TypeToken<List<Course>>() {}.getType());

        Collections.shuffle(courseList);
        return courseList;
    }

    static String courseJson = "[\n" +
            "  {\n" +
            "    \"title\":\"Early math\",\n" +
