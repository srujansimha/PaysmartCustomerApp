...
public class VehicleTypesList {
    ...
    public static ArrayList<DirectoryHome9CategoryVO> getCategoryList() {
        return new Gson().fromJson(categoryJson, new TypeToken<ArrayList<GetalyftVehiclelist>>() {
        }.getType());
    }
    ...
    public static ArrayList<GetalyftVehiclelist> getVehicleTypes() {
        return new Gson().fromJson(vehicleTypesJson, new TypeToken<ArrayList<GetalyftVehiclelist>>() {
        }.getType());
    }
