...
import com.webingate.paysmartcustomerapp.object.Chat;
...
public class GeneralChatListRepository {
    public static ArrayList<Chat> getGeneralChatList() {
        return new Gson().fromJson(json, new TypeToken<ArrayList<Chat>>() {}.getType());
    }
