package com.webingate.paysmartcustomerapp.repository.customerapp;
...
public class customerappRepository {
    ...
    public static ArrayList<GeneralList> getcountriesListJson() {
        return new Gson().fromJson(countriesListJson, new TypeToken<ArrayList<GeneralList>>() {
        }.getType());
    }
    ...
    private static String countriesListJson = "[\n" +
            "  {\n" +
            "    \"id\": \"1\",\n" +
            "    \"image\": \"zimbabwe\",\n" +
            "    \"name\": \"Zimbabwe\",\n" +
