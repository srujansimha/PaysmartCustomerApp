package com.webingate.paysmartcustomerapp.customerapp.Dialog;
...
public class DialogInit {
    ...
    @LayoutRes
    static int getInflateLayout(ProgressDialog.Builder builder) {
...
//            return R.layout.md_dialog_custom;
    ...
    @UiThread
    public static void init(final ProgressDialog dialog) {
        final ProgressDialog.Builder builder = dialog.builder;
    ...
    private static void setupTitle(ProgressDialog dialog, ProgressDialog.Builder builder) {
...
//            dialog.setTypeface(dialog.title, builder.mediumFont);
    ...
    private static void setupSpinner(ProgressDialog dialog, ProgressDialog.Builder builder) {
    ...
    private static void setupListeners(ProgressDialog dialog, ProgressDialog.Builder builder) {
    ...
    private static void setupMessageContent(ProgressDialog dialog, ProgressDialog.Builder builder) {
        // Setup content
