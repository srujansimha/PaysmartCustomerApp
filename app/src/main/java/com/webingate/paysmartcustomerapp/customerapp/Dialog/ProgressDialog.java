...
////        dialog.getWindow().addFlags(WindowManager.LayoutParams.FLAG_BLUR_BEHIND);
    ...
    public static class Builder {
         ...
         * @return {@link Builder} ProgressDialog.Builder
        ...
        /**
         * @param color ProgressDialog background ColorInt
         * @return {@link Builder} ProgressDialog.Builder
         * @deprecated Do not use this method, it's not working now!
         */
        @Deprecated
        ...
        /**
         * @param colorRes ProgressDialog background colorRes
         * @return {@link Builder} ProgressDialog.Builder
         * @deprecated Do not use this method, it's not working now!
         */
        @Deprecated
        ...
        /**
         * @param colorAttr ProgressDialog background colorAttr
         * @return {@link Builder} ProgressDialog.Builder
         * @deprecated Do not use this method, it's not working now!
         */
        @Deprecated
