...
//    @BindView(R.id.bus)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.customerapp_towingvehicle_activity);
        ButterKnife.bind(this);
        dialog = new ProgressDialog.Builder(customerappTowingVehicleActivity.this)
                .setTitle("Loading...")
...
//        bus.setVisibility(View.GONE);
                ...
                try {
                    ...
                    Intent intent =
                            new PlaceAutocomplete.IntentBuilder(PlaceAutocomplete.MODE_FULLSCREEN)
                                    .build(customerappTowingVehicleActivity.this);
        ...
        sourceGpsLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(customerappTowingVehicleActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(customerappTowingVehicleActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ...
                Location location = LocationServices.FusedLocationApi.getLastLocation(mGoogleApiClient);
                LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, customerappTowingVehicleActivity.this);
                lat1= location.getLatitude();
                log1=location.getLongitude();
               /* if (marker != null) {
...
//                    CalculatePrice(object);
                    ...
                    Intent intent = new Intent(customerappTowingVehicleActivity.this, customerappTowingVehicleConfirmActivity.class);
        ...
        rideLater.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectDestination.getText().toString().matches("")) {
                    ...
                    RideLater_Dialoguebox rideLater_dialoguebox = new RideLater_Dialoguebox(customerappTowingVehicleActivity.this);
...
//                                .commitAllowingStateLoss();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                customerappTowingVehicleActivity.DirectionsTask downloadTask2 = new customerappTowingVehicleActivity.DirectionsTask();
                downloadTask2.execute();
                dest = 0;
                LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, customerappTowingVehicleActivity.this);
            }
        });
    ...
    private void initGoogleAPIClient() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(customerappTowingVehicleActivity.this)
    ...
    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(customerappTowingVehicleActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(customerappTowingVehicleActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(customerappTowingVehicleActivity.this,
    ...
    private void requestcallPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(customerappTowingVehicleActivity.this, Manifest.permission.CALL_PHONE)) {
            ActivityCompat.requestPermissions(customerappTowingVehicleActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(customerappTowingVehicleActivity.this, REQUEST_CHECK_SETTINGS);
...
//        rotateMarker(markerCar1, latlngnew, rotation);
   ...
   /* public void GetBookingStatus() {
    ...
    public void SaveBookingDetails(JsonObject jsonObject) {
        StartDialogue();
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappTowingVehicleActivity.this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<SaveBookingDetailsResponse>>() {
                    ...
                    public void onNext(List<SaveBookingDetailsResponse> responselist) {
                        ...
                        if(response.getBookingNumber()!=null) {
                            ...
                            checkingCabsDialogue = new CheckingCabsDialogue(customerappTowingVehicleActivity.this);
        ...
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappTowingVehicleActivity.this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<CalculatePriceResponse>>() {
                    ...
                    public void onNext(List<CalculatePriceResponse> responselist) {
                        ...
                        Intent intent = new Intent(customerappTowingVehicleActivity.this, customerappGetaLyftDetailsActivity.class);
                ...
                .subscribe(new Subscriber<List<CustomerBookingStatusResponse>>() {
                    ...
                    public void onNext(List<CustomerBookingStatusResponse> responselist) {
                        ...
                        if (response.getBooKingOTP() != null) {
                            ...
                            isBookingStarted=false;
                            Intent intent = new Intent(customerappTowingVehicleActivity.this, CurrentTrip.class);
        ...
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappTowingVehicleActivity.this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<UpdateBookingstatusResponse>>() {
                    ...
                    public void onNext(List<UpdateBookingstatusResponse> responselist) {
                        AlertDialog alertDialog = new AlertDialog.Builder(customerappTowingVehicleActivity.this, R.style.Dialog_Theme).create();
