...
public class customerappAddPaymentBankingActivity extends AppCompatActivity {


    private LinearLayout acnt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.customerapp_paymentmode_banking);
        acnt=(LinearLayout)findViewById(R.id.acnt);
    ...
    private void initActions() {
        ...
        acnt.setOnClickListener(v ->{
            Toast.makeText(this, "clicked one Add Card", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(customerappAddPaymentBankingActivity.this,customerappPaymentCardDetails.class));
        ...
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<AddCardResponse>>() {
                    ...
                    public void onNext(List<AddCardResponse> responselist) {
                        ...
                        clist.setText((responselist.size()) +" Linked Account(s)");
                        madpter = new customerappCardListAdapter(response);
                        recyclerView.setAdapter(madpter);
                        madpter.setOnItemClickListener((view, obj, position) ->
                                {
                                    DisplayToast("Clicked Confirm");
                                    Intent intent=new Intent(customerappAddPaymentBankingActivity.this,customerappPaymentModeDetails.class);
