...
public class customerewalletActivity extends AppCompatActivity {
...
String id,email,useracntno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.customerapp_ewallet_activity);
...
//            startActivity(intent);
    ...
    public void MtopVerification(JsonObject jsonObject){
                ...
                .subscribe(new Subscriber<List<MOTPVerificationResponse>>() {
                    ...
                    public void onNext(List<MOTPVerificationResponse> responselist) {
                        ...
                        if (response.getCode() != null) {
                            ...
                            Intent intent = new Intent(customerewalletActivity.this, customerEwalletMOTPVerificationActivity.class);
