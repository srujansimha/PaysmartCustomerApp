...
public class customerappHireVehicleConfirmActivity extends AppCompatActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener,Payments_Dialoguebox.PaymentDetails,RideLater_Dialoguebox.RideLater,CheckingCabsDialogue.checkingcabsDialogue {
...
//    RecyclerView rvProduct;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.customerapp_hirevehicleconfirm_activity);
...
//        id = prefs.getString(ID, null);
 ...
 //      selectsource.setText(C_src);
  //      selectDestination.setText(C_des);
        ...
        dialog = new ProgressDialog.Builder(customerappHireVehicleConfirmActivity.this)
                .setTitle("Loading...")
...
//        bus.setVisibility(View.GONE);
                ...
                try {
                    ...
                    Intent intent =
                            new PlaceAutocomplete.IntentBuilder(PlaceAutocomplete.MODE_FULLSCREEN)
                                    .build(customerappHireVehicleConfirmActivity.this);
        ...
        sourceGpsLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(customerappHireVehicleConfirmActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(customerappHireVehicleConfirmActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ...
                LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, customerappHireVehicleConfirmActivity.this);
               /* if (marker != null) {
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView <?> adapter, View v, int position, long id) {
                            if(position==1)
                            {
                                ...
                                startActivity(new Intent(customerappHireVehicleConfirmActivity.this,customerappPaymentModeDetails.class));
...
//        });
    ...
    public void setDialog(View v) {
        ...
        Intent intent = new Intent(customerappHireVehicleConfirmActivity.this,customerappPaymentModeActivity.class);
    }
    public void onMapReady(GoogleMap googleMap) {
        ...
        customerappHireVehicleConfirmActivity.DirectionsTask downloadTask2 = new customerappHireVehicleConfirmActivity.DirectionsTask();
...
//    }
    ...
    private void initGoogleAPIClient() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(customerappHireVehicleConfirmActivity.this)
    ...
    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(customerappHireVehicleConfirmActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(customerappHireVehicleConfirmActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(customerappHireVehicleConfirmActivity.this,
    ...
    private void requestcallPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(customerappHireVehicleConfirmActivity.this, Manifest.permission.CALL_PHONE)) {
            ActivityCompat.requestPermissions(customerappHireVehicleConfirmActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(customerappHireVehicleConfirmActivity.this, REQUEST_CHECK_SETTINGS);
...
//        }
    ...
    public void onLocationChanged(Location location) {
       ...
       /* if (marker != null) {
        ...
        if (!selectDestination.getText().toString().matches("")) {
            LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, this);
            customerappHireVehicleConfirmActivity.DirectionsTask downloadTask = new customerappHireVehicleConfirmActivity.DirectionsTask();
            downloadTask.execute();
        }
    }
   ...
   /* public void GetBookingStatus() {
    ...
    public void SaveBookingDetails(JsonObject jsonObject) {
        StartDialogue();
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappHireVehicleConfirmActivity.this).getrestadapter()
        ...
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappHireVehicleConfirmActivity.this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<CalculatePriceResponse>>() {
                    ...
                    public void onNext(List<CalculatePriceResponse> responselist) {
                        ...
                        Payments_Dialoguebox payments_dialoguebox = new Payments_Dialoguebox(customerappHireVehicleConfirmActivity.this, response.getPrice()+"");
                ...
                .subscribe(new Subscriber<List<CustomerBookingStatusResponse>>() {
                    ...
                    public void onNext(List<CustomerBookingStatusResponse> responselist) {
                        ...
                        if (response.getBooKingOTP() != null) {
                            ...
                            isBookingStarted=false;
                            Intent intent = new Intent(customerappHireVehicleConfirmActivity.this, CurrentTrip.class);
        ...
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappHireVehicleConfirmActivity.this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<UpdateBookingstatusResponse>>() {
                    ...
                    public void onNext(List<UpdateBookingstatusResponse> responselist) {
                        ...
                        AlertDialog alertDialog = new AlertDialog.Builder(customerappHireVehicleConfirmActivity.this, R.style.Dialog_Theme).create();
