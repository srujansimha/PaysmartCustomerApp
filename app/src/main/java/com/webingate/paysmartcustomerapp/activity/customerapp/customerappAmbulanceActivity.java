...
public class customerappAmbulanceActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener,Payments_Dialoguebox.PaymentDetails,RideLater_Dialoguebox.RideLater,CheckingCabsDialogue.checkingcabsDialogue {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.customerapp_ambulance_activity);
        ButterKnife.bind(this);
        dialog = new ProgressDialog.Builder(customerappAmbulanceActivity.this)
                .setTitle("Loading...")
...
//        bus.setVisibility(View.GONE);
                ...
                try {
                    ...
                    Intent intent =
                            new PlaceAutocomplete.IntentBuilder(PlaceAutocomplete.MODE_FULLSCREEN)
                                    .build(customerappAmbulanceActivity.this);
        ...
        sourceGpsLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(customerappAmbulanceActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(customerappAmbulanceActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ...
                Location location = LocationServices.FusedLocationApi.getLastLocation(mGoogleApiClient);
                LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, customerappAmbulanceActivity.this);
                lat1= location.getLatitude();
                log1=location.getLongitude();
               /* if (marker != null) {
...
//                    CalculatePrice(object);
                    ...
                    Intent intent = new Intent(customerappAmbulanceActivity.this, customerappAmbulanceConfirmActivity.class);
        ...
        rideLater.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectDestination.getText().toString().matches("")) {
                    ...
                    RideLater_Dialoguebox rideLater_dialoguebox = new RideLater_Dialoguebox(customerappAmbulanceActivity.this);
...
//                                .commitAllowingStateLoss();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                customerappAmbulanceActivity.DirectionsTask downloadTask2 = new customerappAmbulanceActivity.DirectionsTask();
                downloadTask2.execute();
                dest = 0;
                LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, customerappAmbulanceActivity.this);
            }
        });
    ...
    private void initGoogleAPIClient() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(customerappAmbulanceActivity.this)
    ...
    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(customerappAmbulanceActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(customerappAmbulanceActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(customerappAmbulanceActivity.this,
    ...
    private void requestcallPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(customerappAmbulanceActivity.this, Manifest.permission.CALL_PHONE)) {
            ActivityCompat.requestPermissions(customerappAmbulanceActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(customerappAmbulanceActivity.this, REQUEST_CHECK_SETTINGS);
...
//        }
    ...
    public void onLocationChanged(Location location) {
       ...
       /* if (marker != null) {
        ...
        if (!selectDestination.getText().toString().matches("")) {
            LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, this);
            customerappAmbulanceActivity.DirectionsTask downloadTask = new customerappAmbulanceActivity.DirectionsTask();
            downloadTask.execute();
        }
...
//        rotateMarker(markerCar1, latlngnew, rotation);
   ...
   /* public void GetBookingStatus() {
    ...
    public void SaveBookingDetails(JsonObject jsonObject) {
        StartDialogue();
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappAmbulanceActivity.this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<SaveBookingDetailsResponse>>() {
                    ...
                    public void onNext(List<SaveBookingDetailsResponse> responselist) {
                        ...
                        if(response.getBookingNumber()!=null) {
                            ...
                            checkingCabsDialogue = new CheckingCabsDialogue(customerappAmbulanceActivity.this);
        ...
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappAmbulanceActivity.this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<CalculatePriceResponse>>() {
                    ...
                    public void onNext(List<CalculatePriceResponse> responselist) {
                        ...
                        Intent intent = new Intent(customerappAmbulanceActivity.this, customerappGetaLyftDetailsActivity.class);
                ...
                .subscribe(new Subscriber<List<CustomerBookingStatusResponse>>() {
                    ...
                    public void onNext(List<CustomerBookingStatusResponse> responselist) {
                        ...
                        if (response.getBooKingOTP() != null) {
                            ...
                            isBookingStarted=false;
                            Intent intent = new Intent(customerappAmbulanceActivity.this, CurrentTrip.class);
        ...
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappAmbulanceActivity.this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<UpdateBookingstatusResponse>>() {
                    ...
                    public void onNext(List<UpdateBookingstatusResponse> responselist) {
                        AlertDialog alertDialog = new AlertDialog.Builder(customerappAmbulanceActivity.this, R.style.Dialog_Theme).create();
