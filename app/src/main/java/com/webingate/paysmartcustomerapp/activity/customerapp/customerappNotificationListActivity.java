...
public class customerappNotificationListActivity extends AppCompatActivity {


    String regno,vimage,vgrp,vtype,vcode;

   // ArrayList<Place> placeArrayList;
   customerappNotificationAdapter adapter;
    // RecyclerView
...
//    private LinearLayout linearCamera;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.customerapp_notificationlist_activity);
...
//        GetVehilcelist(ctryid,fid,vgid);
    ...
    private void initUI()
    {
        ...
        // get list adapter
        adapter = new customerappNotificationAdapter(null,getApplicationContext());
