...
public class customerappAmbulanceConfirmActivity extends AppCompatActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener,Payments_Dialoguebox.PaymentDetails,RideLater_Dialoguebox.RideLater,CheckingCabsDialogue.checkingcabsDialogue {
...
//        id = prefs.getInt(ID, null);
 ...
 //      selectsource.setText(C_src);
  //      selectDestination.setText(C_des);
        ...
        dialog = new ProgressDialog.Builder(customerappAmbulanceConfirmActivity.this)
                .setTitle("Loading...")
...
//        bus.setVisibility(View.GONE);
                ...
                try {
                    ...
                    Intent intent =
                            new PlaceAutocomplete.IntentBuilder(PlaceAutocomplete.MODE_FULLSCREEN)
                                    .build(customerappAmbulanceConfirmActivity.this);
        ...
        sourceGpsLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(customerappAmbulanceConfirmActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(customerappAmbulanceConfirmActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ...
                LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, customerappAmbulanceConfirmActivity.this);
               /* if (marker != null) {
                    ...
                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView <?> adapter, View v, int position, long id) {
                            if(position==1)
                            {
                                ...
                                startActivity(new Intent(customerappAmbulanceConfirmActivity.this,customerappPaymentModeDetails.class));
...
//        });
    ...
    public void setDialog(View v) {
        ...
        Intent intent = new Intent(customerappAmbulanceConfirmActivity.this,customerappPaymentModeActivity.class);
    }
    public void onMapReady(GoogleMap googleMap) {
        ...
        customerappAmbulanceConfirmActivity.DirectionsTask downloadTask2 = new customerappAmbulanceConfirmActivity.DirectionsTask();
...
//    }
    ...
    private void initGoogleAPIClient() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(customerappAmbulanceConfirmActivity.this)
    ...
    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(customerappAmbulanceConfirmActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(customerappAmbulanceConfirmActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(customerappAmbulanceConfirmActivity.this,
    ...
    private void requestcallPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(customerappAmbulanceConfirmActivity.this, Manifest.permission.CALL_PHONE)) {
            ActivityCompat.requestPermissions(customerappAmbulanceConfirmActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(customerappAmbulanceConfirmActivity.this, REQUEST_CHECK_SETTINGS);
            ...
            case PLACE_AUTOCOMPLETE_REQUEST_CODE:
                if (dest == 1) {
                    ...
                    if (source != null) {
                        ...
                        // Getting Directions from source to destination
                        if (!selectDestination.getText().toString().matches("")) {
                            customerappAmbulanceConfirmActivity.DirectionsTask downloadTask = new customerappAmbulanceConfirmActivity.DirectionsTask();
...
//        }
   ...
   /* public void GetBookingStatus() {
    ...
    public void SaveBookingDetails(JsonObject jsonObject) {
        StartDialogue();
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappAmbulanceConfirmActivity.this).getrestadapter()
        ...
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappAmbulanceConfirmActivity.this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<CalculatePriceResponse>>() {
                    ...
                    public void onNext(List<CalculatePriceResponse> responselist) {
                        ...
                        Payments_Dialoguebox payments_dialoguebox = new Payments_Dialoguebox(customerappAmbulanceConfirmActivity.this, response.getPrice()+"");
                ...
                .subscribe(new Subscriber<List<CustomerBookingStatusResponse>>() {
                    ...
                    public void onNext(List<CustomerBookingStatusResponse> responselist) {
                        ...
                        if (response.getBooKingOTP() != null) {
                            ...
                            isBookingStarted=false;
                            Intent intent = new Intent(customerappAmbulanceConfirmActivity.this, CurrentTrip.class);
        ...
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappAmbulanceConfirmActivity.this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<UpdateBookingstatusResponse>>() {
                    ...
                    public void onNext(List<UpdateBookingstatusResponse> responselist) {
                        ...
                        AlertDialog alertDialog = new AlertDialog.Builder(customerappAmbulanceConfirmActivity.this, R.style.Dialog_Theme).create();
