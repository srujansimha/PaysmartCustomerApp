...
public class customerEwalletMOTPVerificationActivity extends AppCompatActivity {
...
//            startActivity(intent);
    ...
    public void MOTPVerifications(JsonObject jsonObject){
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerEwalletMOTPVerificationActivity.this).getrestadapter()
...
//                            SharedPreferences.Editor editor = sharedpreferences.edit();
//                            editor.putString(Mobileotp, null);
                            Intent intent = new Intent(customerEwalletMOTPVerificationActivity.this, DashboardEWallet.class);
