...
public class customerappBusActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener,Payments_Dialoguebox.PaymentDetails,RideLater_Dialoguebox.RideLater,CheckingCabsDialogue.checkingcabsDialogue {
    ...
    int updatemarkers = 0;
    private Marker cabs[] = new Marker[3];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog.Builder(customerappBusActivity.this)
                .setTitle("Loading...")
...
//        bus.setVisibility(View.GONE);
        ...
        sourceGpsLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(customerappBusActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(customerappBusActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ...
                Location location = LocationServices.FusedLocationApi.getLastLocation(mGoogleApiClient);
                LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, customerappBusActivity.this);
                lat1= location.getLatitude();
                log1=location.getLongitude();
               /* if (marker != null) {
...
//                    CalculatePrice(object);
                    ...
                    Intent intent = new Intent(customerappBusActivity.this, customerappGetaLyftConfirmActivity.class);
        ...
        rideLater.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectDestination.getText().toString().matches("")) {
                    ...
                    RideLater_Dialoguebox rideLater_dialoguebox = new RideLater_Dialoguebox(customerappBusActivity.this);
...
//                markerOptions.title("Destination : " + (destLatitude + "").substring(0, 10) + " , " + (destLongitude + "").substring(0, 10));
//                markerOptions.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA));
//                if (markerDesst != null)
//                    markerDesst.remove();
//                markerDesst = mMap.addMarker(markerOptions);
//                // Getting Directions from source to destination
//                customerappBusActivity.DirectionsTask downloadTask2 = new customerappBusActivity.DirectionsTask();
//                downloadTask2.execute();
//                dest = 0;
//                LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, customerappBusActivity.this);
//            }
//        });
    ...
    private void initGoogleAPIClient() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(customerappBusActivity.this)
    ...
    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(customerappBusActivity.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(customerappBusActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(customerappBusActivity.this,
    ...
    private void requestcallPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(customerappBusActivity.this, Manifest.permission.CALL_PHONE)) {
            ActivityCompat.requestPermissions(customerappBusActivity.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(customerappBusActivity.this, REQUEST_CHECK_SETTINGS);
            ...
            case PLACE_AUTOCOMPLETE_REQUEST_CODE:
                if (dest == 1) {
                    ...
                    if (source != null) {
                        ...
                        markerOptions.title("Source :" + source.getName() + "," + source.getAddress());
                        markerOptions.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA));
                        if (marker != null)
                            marker.remove();
                        marker = mMap.addMarker(markerOptions);
...
//        }
    ...
    public void onLocationChanged(Location location) {
       ...
       /* if (marker != null) {
        ...
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(latlngnew);
        markerOptions.title("Source :"+sourceLatitude+","+sourceLongitude);
        markerOptions.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA));
        if (marker != null)
            marker.remove();
        marker = mMap.addMarker(markerOptions);
...
//        rotateMarker(markerCar1, latlngnew, rotation);
   ...
   /* public void GetBookingStatus() {
    ...
    public void SaveBookingDetails(JsonObject jsonObject) {
        StartDialogue();
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappBusActivity.this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<SaveBookingDetailsResponse>>() {
                    ...
                    public void onNext(List<SaveBookingDetailsResponse> responselist) {
                        ...
                        if(response.getBookingNumber()!=null) {
                            ...
                            checkingCabsDialogue = new CheckingCabsDialogue(customerappBusActivity.this);
        ...
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappBusActivity.this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<CalculatePriceResponse>>() {
                    ...
                    public void onNext(List<CalculatePriceResponse> responselist) {
                        ...
                        Intent intent = new Intent(customerappBusActivity.this, customerappGetaLyftDetailsActivity.class);
                ...
                .subscribe(new Subscriber<List<CustomerBookingStatusResponse>>() {
                    ...
                    public void onNext(List<CustomerBookingStatusResponse> responselist) {
                        ...
                        if (response.getBooKingOTP() != null) {
                            ...
                            isBookingStarted=false;
                            Intent intent = new Intent(customerappBusActivity.this, CurrentTrip.class);
        ...
        com.webingate.paysmartcustomerapp.customerapp.Utils.DataPrepare.get(customerappBusActivity.this).getrestadapter()
                ...
                .subscribe(new Subscriber<List<UpdateBookingstatusResponse>>() {
                    ...
                    public void onNext(List<UpdateBookingstatusResponse> responselist) {
                        AlertDialog alertDialog = new AlertDialog.Builder(customerappBusActivity.this, R.style.Dialog_Theme).create();
