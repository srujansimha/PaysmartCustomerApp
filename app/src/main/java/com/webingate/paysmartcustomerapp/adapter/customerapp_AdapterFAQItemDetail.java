...
import com.webingate.paysmartcustomerapp.utils.ViewAnimation;

import java.util.ArrayList;
import java.util.List;

public class customerapp_AdapterFAQItemDetail extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public customerapp_AdapterFAQItemDetail(Context context, List<Social> items) {
        this.items = items;
        ctx = context;
    }
