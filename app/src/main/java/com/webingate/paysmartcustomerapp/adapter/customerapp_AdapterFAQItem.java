...
public class customerapp_AdapterFAQItem extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public customerapp_AdapterFAQItem(Context context, List<People> items) {
        this.items = items;
        ctx = context;
    }
